...
<body ng-app="dongyimai" ng-controller="itemController" ng-init="num=1;loadSku()">
						...
						<div id="specification" class="summary-wrap clearfix">
                            <#list specificationItems as spec>
                                <dl>
                                    ...
                                    <dd>
                                        <a  class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}"
                                            ng-click="addspec('${spec.attributeName}','${value}')">
                                            ${value}
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
										<input autocomplete="off" type="text" value="{{num}}" minnum="1" ng-model="num" class="itxt" />
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a ng-click="addToCart()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
